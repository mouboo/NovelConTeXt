...
%Titlepage
\startmakeup[standard][page=right, doublesided=no,top=,]
\qquad{\mytitlefont Metamorphosis}

\qquad by Franz Kafka

\qquad Translated by David Wyllie
\stopmakeup


%Copyrightpage
\startmakeup[standard][page=yes, doublesided=no,bottom=,]
\startlines
copyright stuff
another line
a third line
